# ВКР САФУ - Бакалавриат. Генерация датасета с помощью GAN/Diffusion подходов
...
На изображении сверху видно восстановленную бинарную маску, где по краям были пустые-маскированные области, внизу видно маску-таргет. Результат не сильно точный, но показывает, что можно достичь высокого результата на большем датасете, в данном случае, исходных снимков было предоставлено для обучения всего-лишь 9, где приемлемых для обучения оказалось лишь 5.
Обучение происходило на одной видеокарте RTX4080 на 1000 эпохах с размером батча в 32.
